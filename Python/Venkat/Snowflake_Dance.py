...
class LED:
    ...
    def set_disco_colors(self, colors):
        ...
        for i in range(1, self.NUM_LEDS + 1):
            Subu.setSingleLED(i, urandom.choice(colors))

    def off(self):
        self.set_all(0, 0, 0)

# --- வன்பொருள் பாகங்களை தொடங்குதல் ---
motor = Motor(a1_pin=Subu.IO18, a2_pin=Subu.IO19, b1_pin=Subu.IO20, b2_pin=Subu.IO21, speed=1.0, turn_speed=0.7)
#led = LED(num_leds=48)
...
try:
    ...
    def spin():
        ...
        for _ in range(steps):
             # சுழலும்போது வண்ணங்களை மாற்றுகிறது
