...
# --- Configuration ---
WIFI_SSID = "Subu-Car-Control"
WIFI_PASSWORD = "password123"

# --- UART (Serial) Communication Setup ---
# Use UART 1. Connect ESP32's TX (17) to Subu's RX and ESP32's RX (16) to Subu's TX.
...
def get_web_page_html():
    ...
    <html lang="en">
    <head>
        <title>Subu Wi-Fi Control</title>
...
while True:
    try:
        ...
        if cmd_start != -1:
            ...
            # Send the command over UART to the Subu board
            uart.write(command + '\n')
