...
# --- Configuration ---
WIFI_SSID = "Snowflake-Radar"
WIFI_PASSWORD = "password123"

# --- UART (Serial) Communication Setup ---
# Use UART 1. Connect ESP32's TX (Cayo.IO9) to Snowflake's RX (IO2)
# and ESP32's RX (Cayo.IO10) to Snowflake's TX (IO1).
