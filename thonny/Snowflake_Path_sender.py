...
# --- Configuration ---
WIFI_SSID = "Snowflake-Path-Control"
WIFI_PASSWORD = "password123"

# --- UART (Serial) Communication Setup ---
# ESP32's TX (IO9) to Snowflake's RX and ESP32's RX (IO10) to Snowflake's TX.
uart = UART(1, baudrate=115200, tx=Trix.IO9, rx=Trix.IO10) 
print("UART configured on tx=Trix.IO9, rx=Trix.IO10.")
...
def get_web_page_html():
    ...
    <html lang="en">
    <head>
        <title>Snowflake Path Control</title>
...
print("--- Snowflake Path Control Server ---")
